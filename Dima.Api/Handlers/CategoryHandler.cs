    ...
    public class CategoryHandler(AppDbContext context) : ICategoryHandler
    {
        public async Task<Response<Category?>> CreateAsync(CreateCategoryRequest request)
        {
            try
            {
                ...
                return new Response<Category?>(category, 201, "Categoria criada com sucesso!"); //Retorna a categoria criada
            }
            catch
            {
        ...
        public async Task<Response<Category?>> DeleteAsync(DeleteCategoryRequest request)
        {
            try
            {
                ...
                return new Response<Category?>(category, 200, message: "Categoria excluida com sucesso!");
            }
            catch
            {
        ...
        public async Task<Response<Category?>> GetByIdAsync(GetCategoryByIdRequest request)
        {
            try
            {
                ...
                ? new Response<Category?>(null, 404, "Categoria não enocntrada")
